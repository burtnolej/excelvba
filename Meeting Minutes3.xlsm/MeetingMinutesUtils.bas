...
Dim outputRange As Range
    ...
    Set outputRange = Application.Run("vbautils.xlsm!HTTPDownloadFile", url + "entries_meetings.csv", _
                ActiveWorkbook, _
                "", "", 0, "start-of-day", "ENTRIES_MEETINGS", False, 1)
                
    Application.Run "vbautils.xlsm!SortRange", outputRange.Worksheet, outputRange, 1
    
    
    Application.StatusBar = "loading http://172.22.237.138/datafiles/person.csv"
    Set outputRange = Application.Run("vbautils.xlsm!HTTPDownloadFile", url + "person.csv", _
                ActiveWorkbook, _
                "", "", 0, "start-of-day", "PERSON", False, 1)
                
    Application.Run "vbautils.xlsm!SortRange", outputRange.Worksheet, outputRange, 1
    'Application.Run "vbautils.xlsm!SortRange", outputRange.Worksheet, outputRange, 14
    ...
    Set outputRange = Application.Run("vbautils.xlsm!HTTPDownloadFile", url + "opportunities.csv", _
                ActiveWorkbook, _
                "", "", 0, "start-of-day", "OPPORTUNITY", False, 1)
    
    Application.Run "vbautils.xlsm!SortRange", outputRange.Worksheet, outputRange, 16
