...
Function GetNow() As String
    GetNow = Application.Run("vbautils.xlsm!GetNow")
End Function
Sub PopulateWordDocFromExcel(Optional param As Variant)
...
'
    ...
    targetFolder = "E:\Velox Financial Technology\Velox Shared Drive - Documents\General\Sales Team\Meeting Summaries\"
    offset = 1
    itemRowHeight = 15
    numTableColumns = 4


    'If IsWorkBookOpen("E:\Velox Financial Technology\OneDrive - Velox Financial Technology\Desktop\vbautils.xlsm") = False Then
    '    Application.Workbooks.Open "E:\Velox Financial Technology\OneDrive - Velox Financial Technology\Desktop\vbautils.xlsm"
    'End If

    Application.Run "vbautils.xlsm!KillApp", "winword.exe"
    ...
    Set wordTable = wordDoc.Tables.Add(wordRange, 60, numTableColumns, wdWord9TableBehavior, wdAutoFitFixed)
    ...
    For columnHeaderCursor = 1 To numHeaders
        ...
        Set newColumnRange = firstColumnCell.Resize(15)
