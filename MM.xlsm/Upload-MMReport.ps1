...
Read-Host "Uploading " +  $source_file + " ..... Press RETURN to continue"

Upload-MMReport $source_file

Read-Host "Uploaded here /sites/VeloxSharedDrive/Shared%20Documents/General/Sales Team/Meeting Summaries  ..... Press RETURN to continue"
