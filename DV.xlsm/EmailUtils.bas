...
Sub createEmail(toStr As String, ccStr As String, _
        subjectStr As String, content As String, Optional myAttachment As String, Optional sendFlag As Boolean = False)
...
Dim myHTMLBody As String
    ...
    With outMail
        ...
        '.HTMLBody = GetClipboardDataAsString(0, 1) ' 49382
        '.HTMLBody = ClipBoard_GetData
        .HTMLBody = content
        .Attachments.Add myAttachment, 1, 0
